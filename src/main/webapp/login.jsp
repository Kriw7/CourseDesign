...
<body>
    ...
    <div id="center" >
        <div id="loginArea" align="center">
            <div>
                <form action="/page/login.do" id="loginForm" method="post">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label class="label_radio"><input type="radio" name="type" value="student" checked >学生</label>
                                <label class="label_radio"><input type="radio" name="type" value="manager" >管理员</label>
                            </td>
                        </tr>
                    </table>
                </form>
